...
namespace Structure_Code.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(Structure_CodeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'Structure_CodeContext.Author'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Structure_CodeContext.Author'  is null.");
            }
            var author = await _context.Author.FindAsync(id);
            if (author != null)
            {
